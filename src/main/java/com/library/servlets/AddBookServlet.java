...
public class AddBookServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String availability = request.getParameter("availability") != null ? request.getParameter("availability")
					: "Available";

			System.out.println("[DEBUG] Extracted Parameters - Title: " + title + ", Author: " + author + ", Genre: "
					+ genre + ", Availability: " + availability);
